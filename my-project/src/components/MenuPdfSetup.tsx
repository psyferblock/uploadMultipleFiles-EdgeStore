  ...
  files: z
    .array(
      z.object({
        ...
        url: z.string().min(1, { message: "you missed the url of the file" }),
        fileOrder: z
          .number()
...
export function MenuPdfSetup({ entityId }: { entityId: string }) {
  ...
  const handleDeleteImage = (key: string) => {
    ...
    console.log("newValue", newValue, "deletedValue", arrayWithRemovedValue);
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      ...
                      <MultiFileDropzone
                        ...
                        onFilesAdded={async (addeFiles) => {
                          setFileStates([...fileStates, ...addeFiles]);

                          const newValues = [...fileStates];
                          setValues([
                            ...newValues.map((file) => ({
                              key: file.key,
